    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          {step === 2 && <StepSearchBusiness onSelect={handleBusinessSelect} onBack={() => setStep(1)} />}
          {step === 3 && selectedBusiness && (
            <StepConfirmBusiness business={selectedBusiness} onConfirm={handleConfirm} onBack={() => setStep(2)} />
          )}
        </div>
      </DialogContent>
    </Dialog>
